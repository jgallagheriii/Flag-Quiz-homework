...
public class QuizFragment extends Fragment 
{
   ...
   public static String SCORES = "pref_highScores";
   ...
   private Set<String> allHighScoresSet; // world regions in current quiz
   ...
   public void updateScores(SharedPreferences sharedPreferences)
   {
//	   int i = 0;
//	   Set<String> aallHighScores = new Set<String>();
	   allHighScoresSet=sharedPreferences.getStringSet(MainActivity.REGIONS, null);
	   sh=sharedPreferences;
//	   allHighScores.addAll(aallHighScores);
//	   Collections.sort(allHighScores);
//	   while (i <5)
//	   {
//		   topFiveScores.add(allHighScores.remove(0));
//		   i++;
//	   }
//	   SharedPreferences.Editor editor = sharedPreferences.edit();
//	   Set<String> top=new HashSet<String>(topFiveScores);
//	   editor.putStringSet(MainActivity.SCORES, (Set<String>)top);
//	   editor.commit();
   }
      ...
      public void onClick(View v) 
      {
         ...
         if (guess.equals(answer)) // if the guess is correct
         {
            ...
            if (correctAnswers == FLAGS_IN_QUIZ) 
            {
            	...
            	while(!endloop)
            	{
            		for(String score : allHighScoresSet)
            		{
            			if(pointsScored > Integer.parseInt(score))
            			{
            				allHighScoresSet.remove(score);
            				allHighScoresSet.add(Integer.toString(pointsScored));
            				endloop = true;
            			}
            		}
            	}
            	SharedPreferences.Editor editor = sh.edit();
            	editor.putStringSet("pref_Highscores", allHighScoresSet);
            	editor.commit();
                  ...
                  new DialogFragment()
                  {
                     ...
                     public Dialog onCreateDialog(Bundle bundle)
                     {
                        ...
                        builder.setMessage(
                           ...
                           totalGuesses, (1000 / (double) totalGuesses), totalFirstGuesses, pointsScored));
